...
function createColumnData(key, phrase, isNumeric=false, rowToValue=(row) => row[key]) {
  return {
    key,
    phrase,
    rowToValue,
...
export const COLUMN_DATA = {
  ...
  SUPERVISOR_DISTRICT: createColumnData('supervisor_district', 'Supervisor District'),
  ...
  AFFORDABLE_UNITS: createColumnData('affordable_units', 'Affordable Units', true),
  AFFORDABLE_BEDS: createColumnData('affordable_beds', 'Affordable Beds', true),
  SINGLE_ROOM_OCCUPANCY_UNITS: createColumnData('single_room_occupancy_units', 'Single Room Occupancy Units', true),
  STUDIO_UNITS: createColumnData('studio_units', 'Studio Units', true),
  ONE_BEDROOM_UNITS: createColumnData('_1_bedroom_units', '1 Bedroom Units', true),
  TWO_BEDROOM_UNITS: createColumnData('_2_bedroom_units', '2 Bedroom Units', true),
  THREE_BEDROOM_UNITS: createColumnData('_3_bedroom_units', '3 Bedroom Units', true),
  FOUR_BEDROOM_UNITS: createColumnData('_4_bedroom_units', '4 Bedroom Units', true),
  FIVE_PLUS_BEDROOM_UNITS: createColumnData('_5_bedroom_or_larger_units', '5+ Bedroom Units', true),
  ...
  UNITS_AT_120_AMI: createColumnData('units_at_120_ami', 'Units at 120 AMI', true),
  UNITS_GREATER_THAN_120_AMI: createColumnData('units_greater_than_120_ami', 'Units Greater than 120 AMI', true),
  YEAR_BUILDING_CONSTRUCTED: createColumnData('year_building_constructed', 'Year Constructed', true),
  YEAR_AFFORDABILITY_BEGAN: createColumnData('year_affordability_began', 'Year Affordability Began', true),
